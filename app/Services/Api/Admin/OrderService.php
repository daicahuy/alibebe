...
class OrderService
{
    ...
    {
        return $this->orderRepository->filterOrdersByUser($filters, $page, $limit, $user_id, $search);
    }
    ...
    {
        return $this->orderOrderStatusRepository->changeStatusOrder($idOrder, $idStatus, $user_id);
    }
