...
class UserSeeder extends Seeder
{
    ...
    private function fakeCustomer()
    {
        ...
        $lastNames = [
            'Trinh', 'Huệ', 'Hoa', 'Quỳnh', 'Thắm', 'Duyên', 'Diệu', 'Nga',
            'Thúy', 'Hường', 'Thu', 'Hà', 'Linh', 'My', 'Huy', 'Sơn', 'Mạnh',
            'Quân', 'Tùng', 'Bảo', 'Ánh', 'Trung'
        ];
        ...
        $wards = [
            ...
            'Đan Phượng', 'Bắc Từ Liêm', 'Nam Từ Liêm', 'Mỹ Đình', 'Hoàn Kiếm'
        ];

        $districts = [
            'Ba Đình', 'Hoàn Kiếm', 'Hai Bà Trưng', 'Thanh Xuân', 'Cầu Giấy', 
            'Bình Thạnh', 'Gò Vấp', 'Thủ Đức', 'Tân Bình', 'Tân Phú'
        ];

        $cities = [
            'Hà Nội', 'Hồ Chí Minh', 'Đà Nẵng', 'Hải Phòng', 'Cần Thơ', 
            'Huế', 'Nha Trang', 'Vũng Tàu', 'Bình Dương', 'Đồng Nai'
        ];
        ...
        for ($i = 1; $i < 51; $i++) {
            $users[] = [
                ...
                'password' => Hash::make('123456789'),
                'fullname' => fake()->randomElement($firstNames) . ' ' . fake()->randomElement($middleNames) . ' ' . fake()->randomElement($lastNames),
            ...
            $userAddress[] = [
                "user_id" => $i,
                "address" => fake()->randomElement($wards) . ' ' . fake()->randomElement($districts) . ' ' . fake()->randomElement($cities),
                "id_default" => 1,
                'created_at' => now(),
                'updated_at' => now(),
            ];
