            ...
            <div class="row">
                <div class="col-xxl-6 col-xl-5 col-lg-6 d-lg-block d-none ms-auto">
                    <div class="image-contain">
                        <img src="{{ asset('theme/client/assets/images/inner-page/sign-up.png') }}" class="img-fluid" alt="">
                    </div>
                </div>
                    ...
                    <div class="log-in-box">
                        ...
                        <div class="input-box">
                            <form class="row g-4">
                                ...
                                <div class="col-12">
                                    <div class="form-floating theme-form-floating">
                                        <input type="email" class="form-control" id="email" placeholder="Email Address (Optional)">
                        ...
                        <div class="sign-up-box">
                            ...
                            <a href="{{ route('auth.customer.showFormLogin') }}">Log In</a>
                        </div>
                    </div>
                </div>
