                            ...
                            <div class="category-menu">
                                ...
                                <ul class="product-list border-0 p-0 d-block">
                                    <li>
                                        <div class="offer-product">
                                            <a href="product-left-thumbnail.html" class="offer-image">
                                                <img src="{{ asset('theme/client/assets/images/vegetable/product/23.png') }}"
                                                    class="blur-up lazyload" alt="">
                                            </a>
                                    ...
                                    <li>
                                        <div class="offer-product">
                                            <a href="product-left-thumbnail.html" class="offer-image">
                                                <img src="{{ asset('theme/client/assets/images/vegetable/product/24.png') }}"
                                                    class="blur-up lazyload" alt="">
                                            </a>
                                    ...
                                    <li>
                                        <div class="offer-product">
                                            <a href="product-left-thumbnail.html" class="offer-image">
                                                <img src="{{ asset('theme/client/assets/images/vegetable/product/25.png') }}"
                                                    class="blur-up lazyload" alt="">
                                            </a>
                                    ...
                                    <li class="mb-0">
                                        <div class="offer-product">
                                            <a href="product-left-thumbnail.html" class="offer-image">
                                                <img src="{{ asset('theme/client/assets/images/vegetable/product/26.png') }}"
                                                    class="blur-up lazyload" alt="">
                                            </a>
                                    ...
                                    <div class="row m-0">
                                        <div class="col-12 px-0">
                                            <div class="product-box">
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="{{ asset('theme/client/assets/images/vegetable/product/3.png') }}"
                                                            class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                    <ul class="product-option">
                                                        <li data-bs-toggle="tooltip" data-bs-placement="top"
                                        ...
                                        <div class="col-12 px-0">
                                            <div class="product-box">
                                                ...
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="{{ asset('theme/client/assets/images/vegetable/product/4.png') }}"
                                                            class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                    <ul class="product-option">
                                                        <li data-bs-toggle="tooltip" data-bs-placement="top"
                                    ...
                                    <div class="row m-0">
                                        <div class="col-12 px-0">
                                            <div class="product-box">
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="{{ asset('theme/client/assets/images/vegetable/product/5.png') }}"
                                                            class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                    <ul class="product-option">
                                                        <li data-bs-toggle="tooltip" data-bs-placement="top"
                                        ...
                                        <div class="col-12 px-0">
                                            <div class="product-box">
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="{{ asset('theme/client/assets/images/vegetable/product/6.png') }}"
                                                            class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                    <ul class="product-option">
                                                        <li data-bs-toggle="tooltip" data-bs-placement="top"
                                    ...
                                    <div class="row m-0">
                                        <div class="col-12 px-0">
                                            <div class="product-box">
                                                ...
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="{{ asset('theme/client/assets/images/vegetable/product/7.png') }}"
                                                            class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                    <ul class="product-option">
                                                        <li data-bs-toggle="tooltip" data-bs-placement="top"
                                        ...
                                        <div class="col-12 px-0">
                                            <div class="product-box">
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="{{ asset('theme/client/assets/images/vegetable/product/8.png') }}"
                                                            class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                    <ul class="product-option">
                                                        <li data-bs-toggle="tooltip" data-bs-placement="top"
                                    ...
                                    <div class="row m-0">
                                        <div class="col-12 px-0">
                                            <div class="product-box">
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="{{ asset('theme/client/assets/images/vegetable/product/9.png') }}"
                                                            class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                    <ul class="product-option">
                                                        <li data-bs-toggle="tooltip" data-bs-placement="top"
                                        ...
                                        <div class="col-12 px-0">
                                            <div class="product-box">
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="{{ asset('theme/client/assets/images/vegetable/product/10.png') }}"
                                                            class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                    <ul class="product-option">
                                                        <li data-bs-toggle="tooltip" data-bs-placement="top"
                        ...
                        <div>
                            <ul class="product-list">
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{ asset('theme/client/assets/images/vegetable/product/11.png') }}"
                                                class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{ asset('theme/client/assets/images/vegetable/product/12.png') }}"
                                                class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{ asset('theme/client/assets/images/vegetable/product/13.png') }}"
                                                class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{ asset('theme/client/assets/images/vegetable/product/14.png') }}"
                                                class="blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <ul class="product-list">
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{ asset('theme/client/assets/images/vegetable/product/15.png') }}"
                                                class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{ asset('theme/client/assets/images/vegetable/product/16.png') }}"
                                                class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{ asset('theme/client/assets/images/vegetable/product/17.png') }}"
                                                class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{ asset('theme/client/assets/images/vegetable/product/18.png') }}"
                                                class="blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <ul class="product-list">
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{ asset('theme/client/assets/images/vegetable/product/19.png') }}"
                                                class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{ asset('theme/client/assets/images/vegetable/product/20.png') }}"
                                                class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{ asset('theme/client/assets/images/vegetable/product/21.png') }}"
                                                class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{ asset('theme/client/assets/images/vegetable/product/22.png') }}"
                                                class="blur-up lazyload" alt="">
                                        </a>
