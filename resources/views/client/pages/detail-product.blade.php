                                        ...
                                        <div class="product-main no-arrow">
                                            <div>
                                                <div class="slider-image">
                                                    <img src="{{ asset('theme/client/assets/images/fashion/product/23.jpg') }}"
                                                        id="img-1"
                                                        data-zoom-image="{{ asset('theme/client/assets/images/fashion/product/23.jpg') }}"
                                                        class="
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="{{ asset('theme/client/assets/images/fashion/product/24.jpg') }}"
                                                        data-zoom-image="{{ asset('theme/client/assets/images/fashion/product/24.jpg') }}"
                                                        class="
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="{{ asset('theme/client/assets/images/fashion/product/25.jpg') }}"
                                                        data-zoom-image="{{ asset('theme/client/assets/images/fashion/product/25.jpg') }}"
                                                        class="
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="{{ asset('theme/client/assets/images/fashion/product/26.jpg') }}"
                                                        data-zoom-image="{{ asset('theme/client/assets/images/fashion/product/26.jpg') }}"
                                                        class="
                                ...
                                <ul>
                                        ...
                                        <div class="product-box product-box-bg wow fadeInUp">
                                            <div class="product-image">
                                                <a href="product-left-thumbnail.html">
                                                    <img src="{{ asset('theme/client/assets/images/fashion/product/27.png') }}"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                            </div>
                                    ...
                                    <li>
                                        <div class="product-box product-box-bg wow fadeInUp" data-wow-delay="0.1s">
                                            <div class="product-image">
                                                <a href="product-left-thumbnail.html">
                                                    <img src="{{ asset('theme/client/assets/images/fashion/product/28.png') }}"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                            </div>
                                            <div class="product-detail">
                                    ...
                                    <li>
                                        <div class="product-box product-box-bg wow fadeInUp">
                                            <div class="product-image">
                                                <a href="product-left-thumbnail.html">
                                                    <img src="{{ asset('theme/client/assets/images/fashion/product/29.png') }}"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                            </div>
                                            <div class="product-detail">
                                                            ...
                                                            <li>
                                                                <div class="people-box">
                                                                    <div>
                                                                        <div class="people-image people-text">
                                                                            <img alt="user" class="img-fluid "
                                                                                src="{{ asset('theme/client/assets/images/review/2.jpg') }}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="people-comment">
                                                                        <div class="people-name"><a
                                                            ...
                                                            <li>
                                                                <div class="people-box">
                                                                    <div>
                                                                        <div class="people-image people-text">
                                                                            <img alt="user" class="img-fluid "
                                                                                src="{{ asset('theme/client/assets/images/review/3.jpg') }}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="people-comment">
                                                                        <div class="people-name"><a
                                                            ...
                                                            <li>
                                                                <div class="people-box">
                                                                    <div>
                                                                        <div class="people-image people-text">
                                                                            <img alt="user" class="img-fluid "
                                                                                src="{{ asset('theme/client/assets/images/review/4.jpg') }}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="people-comment">
                                                                        <div class="people-name"><a
                                                            ...
                                                            <li>
                                                                <div class="people-box">
                                                                    <div>
                                                                        <div class="people-image people-text">
                                                                            <img alt="user" class="img-fluid "
                                                                                src="{{ asset('theme/client/assets/images/review/5.jpg') }}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="people-comment">
                                                                        <div class="people-name"><a
            ...
            <div class="title">
                ...
                <span class="title-leaf">
                    <svg class="icon-width">
                        <use
                            xlink:href="https://themes.pixelstrap.com/fastka{{ asset('theme/client/assets/svg/leaf.svg') }}#leaf">
                        </use>
                    </svg>
                </span>
            </div>
                                ...
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-2.html">
                                            <img src="{{ asset('theme/client/assets/images/cake/product/11.png') }}"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 wow fadeInUp" data-wow-delay="0.05s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-thumbnail.html">
                                            <img src="{{ asset('theme/client/assets/images/cake/product/2.png') }}"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 wow fadeInUp" data-wow-delay="0.1s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-thumbnail.html">
                                            <img src="{{ asset('theme/client/assets/images/cake/product/3.png') }}"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 wow fadeInUp" data-wow-delay="0.15s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-thumbnail.html">
                                            <img src="{{ asset('theme/client/assets/images/cake/product/4.png') }}"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 wow fadeInUp" data-wow-delay="0.2s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-thumbnail.html">
                                            <img src="{{ asset('theme/client/assets/images/cake/product/5.png') }}"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 wow fadeInUp" data-wow-delay="0.25s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-thumbnail.html">
                                            <img src="{{ asset('theme/client/assets/images/cake/product/6.png') }}"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 wow fadeInUp" data-wow-delay="0.3s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-thumbnail.html">
                                            <img src="{{ asset('theme/client/assets/images/cake/product/7.png') }}"
                                                class="img-fluid" alt="">
                                        </a>
