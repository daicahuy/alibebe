...
<!-- Feather icon JS -->
<script src="{{ asset('theme/admin/assets/js/icons/feather-icon/feather.min.js') }}"></script>
<script src="{{ asset('theme/admin/assets/js/icons/feather-icon/feather-icon.js') }}"></script>
...
<!-- Customizer JS -->
<script src="{{ asset('theme/admin/assets/js/customizer.js') }}"></script>
