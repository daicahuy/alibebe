                    ...
                    <div class="show-box">
                        <div class="selection-box">
                            ...
                            <form action="{{ route('admin.coupons.restore-selected') }}" method="POST"
                                ...
                                <button type="submit" class="btn btn-outline btn-sm" id="btn-restore-coupon-all">
                                    {{ __('message.restore') }}
                                </button>
                            </form>
                                            ...
                                            <ul id="actions">
                                                <li>
                                                    <form action="{{ route('admin.coupons.restore', $coupon->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        <button class="btn-restore" onclick="return confirm('{{__('message.confirm_restore_out_trash_item')}}')">
...
@push('js')
    <script>
        $(document).ready(function() {
            // --- Logic Checkbox ---
            $('#btn-restore-coupon-all').addClass('visually-hidden');

            $('#checkbox-table').on('click', function() {
                $('#btn-restore-coupon-all').toggleClass('visually-hidden', !$(this).prop('checked'));
            ...
            function updateSelectedCoupons() {
                ...
                $('#btn-restore-coupon-all').toggleClass('visually-hidden', selectedCoupons.length === 0);
            }
            // --- End Logic Checkbox ---
