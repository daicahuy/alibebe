                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <ul id="actions">
                                                    <li>
                                                        <a href="{{ route('admin.users.show', 1) }}" class="btn-detail">
                                                    ...
                                                    <li>
                                                        <form action="" method="POST">
                                                            @csrf
                                                            @method('PUT')
                                                            <button type="submit" class="btn-lock" onclick="return confirm('{{ __('message.confirm_lock_user') }}')">
                                                                <i class="ri-lock-line"></i>
                                                            </button>
                                                        </form>
                                                    </li>
